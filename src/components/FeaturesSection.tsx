...
import { Search, LayoutTemplate, Smartphone, Zap, ShieldCheck, Sparkles, Users as UsersIcon } from 'lucide-react'; 
...
const features: FeatureItem[] = [
  {
    ...
    imageAlt: 'Team collaborating on SEO strategy with charts and graphs',
    dataAiHint: 'seo strategy meeting'
  },
  {
    id: 2,
    icon: LayoutTemplate,
    ...
    imageAlt: 'Modern website design showcasing clear call-to-action buttons and user flow',
    dataAiHint: 'website conversion'
  },
  {
    id: 3,
    icon: Smartphone,
    ...
    imageAlt: 'Website displayed consistently across mobile, tablet, and desktop screens',
    dataAiHint: 'multi device responsive'
  },
  {
    id: 4,
    icon: Zap,
    ...
    imageAlt: 'Abstract visual representation of speed and digital performance metrics',
    dataAiHint: 'digital speed'
  },
  {
    id: 5,
    icon: ShieldCheck, 
    ...
    imageAlt: 'Abstract digital visualization of data security and online protection',
...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-20 md:py-24 lg:py-28 bg-muted/30 dark:bg-gray-900 theme-transition">
      <div className="container mx-auto px-6">
        <motion.div 
          ...
          animate={controls}
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-5 md:mb-6 text-foreground">{siteConfig.featuresSection.title}</h2>
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-4 md:space-x-5">
                    ...
                    <div>
                      <h3 className="text-lg md:text-2xl font-semibold mb-2 md:mb-2.5 text-foreground">{feature.title}</h3>
