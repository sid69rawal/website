...
const CTASection = () => {
  ...
  const { entry, isIntersecting } = useIntersectionObserver(ref, { // Destructure hook result
    threshold: 0.2,
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-br from-primary to-secondary dark:from-primary/90 dark:to-secondary/90 theme-transition">
      {/* Background pattern - consider optimizing or replacing with a more performant SVG or CSS pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <Link 
            href="/#contact" // Updated to Next.js Link, assuming #contact is an ID on the same page
            className={cn(
